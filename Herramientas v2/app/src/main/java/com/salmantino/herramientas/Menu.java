...
public class Menu extends Fragment {
    ...
    private final int[] BOTONESMENU={R.id.linterna, R.id.musica, R.id.nivel, R.id.vibracion, R.id.imgHuella, R.id.grabadora};

    //array que almacena los botones iluminados
    private final int[] BOTONESILUMINADOS = {R.drawable.linterna2, R.drawable.musica2,
            R.drawable.nivel2, R.drawable.vibracion_on, R.drawable.huella_off, R.drawable.grabadora};
