...
public class NivelPantalla extends AppCompatImageView {
    ...
    public NivelPantalla(Context contexto, int lado){
        // recibe el tamaño del espacio de dibujo con "lado"
        ...
        BitmapDrawable bola=(BitmapDrawable) ContextCompat.getDrawable(contexto,
                R.drawable.burbuja);
        burbuja=bola.getBitmap();
        burbuja=Bitmap.createScaledBitmap(burbuja, radioPeq*2, radioPeq*2,
                true);
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec){
        // ajustamos dimensiones de la vista (no trabaja a pantalla completa)
